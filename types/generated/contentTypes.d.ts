...
export interface ApiConciergePageConciergePage extends Struct.SingleTypeSchema {
  collectionName: 'concierge_pages';
  info: {
    displayName: 'Concierge Page';
    pluralName: 'concierge-pages';
    singularName: 'concierge-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    conciergeCard: Schema.Attribute.Component<
      'blocks.image-content-card',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::concierge-page.concierge-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    teamSection: Schema.Attribute.Component<'blocks.team-grid', false>;
    title: Schema.Attribute.String;
    titleBlock: Schema.Attribute.Component<'blocks.text-block', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDiningPageDiningPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featuredContent: Schema.Attribute.Component<
...
export interface ApiDiningDining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cta: Schema.Attribute.Component<'elements.link', true>;
    description: Schema.Attribute.Blocks;
    eventSchedule: Schema.Attribute.Component<'blocks.featured-events', true>;
    featuredImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    features: Schema.Attribute.Component<'elements.meta', true>;
    gallery: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiHeroCarouselHeroCarousel
  extends Struct.CollectionTypeSchema {
...
export interface ApiLeasingPageLeasingPage extends Struct.SingleTypeSchema {
  collectionName: 'leasing_pages';
  info: {
    displayName: 'Leasing Page';
    pluralName: 'leasing-pages';
    singularName: 'leasing-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    contentWithForm: Schema.Attribute.Component<
      'blocks.split-enquiry-content',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiShopShop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cta: Schema.Attribute.Component<'elements.link', true>;
    description: Schema.Attribute.Blocks;
    featured: Schema.Attribute.Component<'blocks.image-feature-grid', false>;
    featuredImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    gallery: Schema.Attribute.Media<
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    storeDetails: Schema.Attribute.Component<'blocks.featured-events', true>;
    testimonals: Schema.Attribute.Relation<
      'oneToMany',
      'api::testimonal.testimonal'
    >;
...
export interface ApiTestimonalTestimonal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    quotedText: Schema.Attribute.Blocks;
...
export interface ApiVisitPageVisitPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactCallout: Schema.Attribute.Component<'blocks.text-block', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'blocks.faq', false>;
    featuredContent: Schema.Attribute.Component<'blocks.split-content', false>;
    hero: Schema.Attribute.Component<'blocks.hero', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    mapSection: Schema.Attribute.Component<'blocks.map', false>;
    publishedAt: Schema.Attribute.DateTime;
    quickInfo: Schema.Attribute.Component<'blocks.section-intro', false>;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::concierge-page.concierge-page': ApiConciergePageConciergePage;
